...
Which can leave you here: N devices, per-device batch of B, and in your head the negative pool is N×B. In reality each device only uses its own B samples as distractors. The question is still B-way.
