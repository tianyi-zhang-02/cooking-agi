...
flowchart TB
    ...
    subgraph U["User understanding · near-real-time"]
        F["Profile view<br/>Qwen3-Embedding-0.6B"] --> H["Multiple user views"]
...
| Candidate/user encoder | [Qwen3-Embedding-0.6B](https://huggingface.co/Qwen/Qwen3-Embedding-0.6B) | Retrieval quality, throughput, long text, vector size, training cost | 4B/8B models are useful capacity bounds but increase training, near-real-time encoding, and iteration cost |
...
- **0.6B:** enough general embedding capacity for initialization while remaining practical to retrain and refresh user representations near-real-time;
