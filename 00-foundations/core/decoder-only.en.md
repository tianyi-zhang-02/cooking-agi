...
<div class="bilingual-note bilingual-intro">
  ...
  <p>The two cards below default to English; select <strong>中文 ↻</strong> to view the equivalent Chinese in place.</p>
</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">1. 推理：最后一个 Assistant 标记是生成起点</div>

用户提交结构化 messages 后，应用先用 [chat template 与 tokenizer](tokenization.en.md)
...
<div class="concept-title-zh" role="heading" aria-level="3">2. 多轮对话只是更长的左侧上下文</div>
...
<div class="bilingual-note bilingual-intro">
  <span>Concept-by-concept · 逐概念双语</span>
  <p>The ten cards below default to English; select <strong>中文 ↻</strong> to view the equivalent Chinese in place.</p>
</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">1. 现代 Block 的整体结构</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">2. RoPE：把位置放进 Q/K 的相对相位</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">3. Pre-Norm 与 RMSNorm：保护残差主干</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">4. SwiGLU：让 FFN 同时生成内容和门</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">5. MHA、MQA 与 GQA：省的是 KV 宽度</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">6. KV Cache：用显存换掉历史重复计算</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">7. FlashAttention：同一公式，更少显存读写</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">8. 长上下文：位置外推与平方成本是两件事</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">9. MoE：扩大 FFN 容量，而不是注意力头</div>
...
<div class="concept-title-zh" role="heading" aria-level="3">10. 把一个现代 Block 从头走一遍</div>
