...
- [Representation and memory](../memory/README.en.md) turn observations into persistent state.
- [Search](../search/README.en.md) determines which future observations are possible.
- [Post-training](../post-training/README.en.md) turns feedback into behavior updates.
- [Evaluation](../evaluation/README.en.md) tests whether the model learned the target or the bias.
